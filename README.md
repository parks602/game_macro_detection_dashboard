...
**![UI구조 이미지](/docs/dashboard_image.png)**
**시작 (main.py 실행)**
...
위치 \project\\run.bat 파일
현재 windows 작업 스케줄러 이용(datamining) 배치 형식 매일 작업
...
* macro\_user\_cosine\_similarity\_detail
    ...
    | ----------- | ----------- | ---------- | ------- |
    | Date | datetime | NULL | 분석 일자 |
    | srcAccountID | varchar | 10 | 계정 고유 ID |
...
* macro\_user\_self\_similarity
    ...
    | srcAccountID | int | NULL | 계정 고유 ID |
...
│   │   │   │   │   comp_dashboard.py             # 메인 대시보드
│   │   │   │   │   comp_dashboard_cosine_sim.py  # 코사인 유사도 분석
│   │   │   │   │   comp_dashboard_cs.py          # 매크로 현황 표시 모듈
│   │   │   │   │   comp_dashboard_self_sim.py    # 자기 유사도 분석
│   │   │   │   │   comp_dashboard_stda.py        # STDA(같은 시간 다른 행동) 분석 모듈
│   │   │   │   │   comp_dashboard_stsa.py        # STSA(같은 시간 같은 행동) 분석 모듈
│   │   │   │   │   comp_dashboard_summary.py     # 대시보드 설명 및 요약
│   │   │   │   │   comp_dashboard_user_search.py # 매크로 탐지 유저 검색 기능
│   │   │   │   │   __init__.py
│   │   │
│   │   ├── sales
...
* **SSL 인증서**: **인증서**를 사용하여 HTTPS 연결을 보장합니다.
